...
def fold = 0; 
def modelName = 'line_ferm' // prejudice_remover //optim_dataPreprocessing //calibrated_eqodds
def dataDir = 'result/stateOfArts/'+modelName+'/'+fold
...
for (Predicate p: inferredPredicates) {
	fileName = 'predict.txt'  // 'score.txt';
